 ...
 */
public class PH_Pushlink extends Activity {
        ...
        public void onError(int code, final String message) {
            if (code == PHMessageType.PUSHLINK_BUTTON_NOT_PRESSED) {
                ...
                if (!isDialogShowing) {
                    ...
                    PH_Pushlink.this.runOnUiThread(new Runnable() {

                        @Override
                        public void run() {
                            AlertDialog.Builder builder = new AlertDialog.Builder(PH_Pushlink.this);
