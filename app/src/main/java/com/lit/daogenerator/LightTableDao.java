...
public class LightTableDao extends AbstractDao<LightTable, Long> {
    ...
    */
    ...
    protected void bindValues(SQLiteStatement stmt, LightTable entity) {
        ...
        Boolean breatheEffect = entity.getBreatheEffect();
        if (breatheEffect != null) {
            stmt.bindLong(8, breatheEffect ? 1l: 0l);
        }
 
        Boolean cycleEffect = entity.getCycleEffect();
        if (cycleEffect != null) {
            stmt.bindLong(9, cycleEffect ? 1l: 0l);
        }
 
        Boolean epilepticEffect = entity.getEpilepticEffect();
